...
Visitor.prototype = {
	...
	screen: function (screenname, appname, appversion, appid, installerid, params, fn) {
		...
		if (typeof screenname === 'object' && screenname != null) {
			...
			screenname = appname = appversion = appid = installerid = null;
		} else if (typeof appname === 'function') {
			fn = appname;
			appname = appversion = appid = installerid = null;
		} else if (typeof appversion === 'function') {
			fn = appversion;
			appversion = appid = installerid = null;
		} else if (typeof appid === 'function') {
			fn = appid;
			appid = installerid = null;
		} else if (typeof installerid === 'function') {
			fn = installerid;
			installerid = null;			
		} else if (typeof params === 'function') {
			fn = params;
		...
		params.aiid = installerid || params.aiid || this._context.aiid;
...
Visitor.prototype.s = Visitor.prototype.screen
